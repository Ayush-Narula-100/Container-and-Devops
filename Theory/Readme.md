...
This repository contains my classwork and hands-on practice for the **Container and DevOps** course. Each lecture includes practical implementations, code examples, and detailed documentation covering various aspects of containerization, orchestration, and DevOps methodologies.

## 📖 Lectures

Explore each lecture's detailed documentation and implementation:
